...
import { deleteChat, updateChat } from "../../redux/contacts/operations";
...
export function Chat(id, chat) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(updateContact({ chatId: id, updatedData: editedChat }))
      .then(() => {
    ...
    <>
      ...
      <div className={css.container}>
        <div className={css.paragraphDiv}>
          ...
          <p className={css.paragraph}>
            <FaPhone className={css.icon} /> {editedContact.surname}
          </p>
        </div>
